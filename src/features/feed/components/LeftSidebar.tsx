...
export default function LeftSidebar() {
  ...
  const handleGoingToggle = (id: number, e: React.MouseEvent) => {
    e.preventDefault();
    setGoingEvents((prev) => ({
      ...prev,
      [id]: !prev[id],
      ...
      <div className="_layout_left_sidebar_wrap">
          ...
          <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            <div className="_left_inner_area_suggest_content _mar_b24">
              ...
              <span className="_left_inner_area_suggest_content_txt">
                <a className="_left_inner_area_suggest_content_txt_link" href="#">
                  See All
                </a>
              </span>
            </div>
              ...
              return (
                <div className="_left_inner_area_suggest_info" key={person.id}>
                  ...
                  <div className="_left_inner_area_suggest_info_link">
                    <a
                      href="#0"
                      className={`_info_link ${isConnected ? "_connected" : ""}`}
                      onClick={(e) => {
                        e.preventDefault();
                        handleConnectToggle(person.id);
                      }}
                      style={isConnected ? {
                        background: "#0ACF83",
                        color: "#fff",
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            {events.map((ev) => {
              const isGoing = !!goingEvents[ev.id];
              return (
                <a className="_left_inner_event_card_link" href="#" key={ev.id}>
                  <div className="_left_inner_event_card">
                    <div className="_left_inner_event_card_iamge">
                      <img src={ev.image} alt="Image" className="_card_img" />
                    </div>
                    <div className="_left_inner_event_card_content">
                      <div className="_left_inner_card_date">
                        <p className="_left_inner_card_date_para">{ev.dateDay}</p>
                        <p className="_left_inner_card_date_para1">{ev.dateMonth}</p>
                      </div>
                    ...
                    <div className="_left_inner_event_bottom">
                      <p className="_left_iner_event_bottom">
                        {isGoing ? ev.goingCount + 1 : ev.goingCount} People Going
                      </p>
                      <button
                        type="button"
