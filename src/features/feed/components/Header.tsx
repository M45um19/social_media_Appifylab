                    ...
                    <div className="_notifications_content">
                      ...
                      <div className="_notification_box_right">
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            setShowNotifySettings(!showNotifySettings);
                          }}
                        >
                        ...
                        <div className={`_notifications_drop_right ${showNotifySettings ? "show" : ""}`}>
                          ...
                          <div className="_notification_box" key={notif.id}>
                            ...
                            <div className="_notification_txt">
                              <p className="_notification_para">
                                <span className="_notify_txt_link">{notif.name} </span>
                                {notif.text}
                              </p>
